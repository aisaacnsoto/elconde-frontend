...
@Component({
	selector: 'app-compra-buscar-producto',
	templateUrl: './compra-buscar-producto.component.html',
	styleUrls: ['./compra-buscar-producto.component.css'],
	providers: [ProductoService]
})
export class CompraBuscarProductoComponent implements OnInit {

	public product: Producto = new Producto();
	public cantidad: number = 1;
	@Output() selectedProduct: EventEmitter<any> = new EventEmitter();
	public table: any = null;
	public tableId: string = 'dtBuscarProductoCompra';
	...
	loadTable(search: boolean = false, searchQuery: string = '') {
		...
		let apiURL = (searchQuery.length == 0)
						? this._productoService.url+'/search/compra'
						: this._productoService.url+'/search/compra/'+searchQuery;

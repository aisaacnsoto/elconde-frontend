...
@Component({
	selector: 'app-cliente-vip-buscar-cliente',
	templateUrl: './cliente-vip-buscar-cliente.component.html',
	styleUrls: ['./cliente-vip-buscar-cliente.component.css'],
	providers: [ClienteService]
})
export class ClienteVipBuscarClienteComponent implements OnInit {

	public cliente: Cliente;
	@Output() selectedCliente: EventEmitter<any> = new EventEmitter();
	public table: any = null;
	public tableId: string = 'dtClienteVIPBuscarCliente';

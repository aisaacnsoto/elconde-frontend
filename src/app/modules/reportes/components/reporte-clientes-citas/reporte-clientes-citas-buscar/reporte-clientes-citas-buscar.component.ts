...
@Component({
	selector: 'app-reporte-clientes-citas-buscar',
	templateUrl: './reporte-clientes-citas-buscar.component.html',
	styleUrls: ['./reporte-clientes-citas-buscar.component.css'],
	providers: [ClienteService]
})
export class ReporteClientesCitasBuscarComponent implements OnInit {

	public cliente: Cliente;
	@Output() selectedCliente: EventEmitter<any> = new EventEmitter();
	public table: any = null;
	public tableId: string = 'dtReporteCitasBuscarCliente';

...
@Component({
	selector: 'app-consumo-buscar-producto',
	templateUrl: './consumo-buscar-producto.component.html',
	styleUrls: ['./consumo-buscar-producto.component.css'],
	providers: [ProductoService]
})
export class ConsumoBuscarProductoComponent implements OnInit {

	public product: Producto = new Producto();
	@Output() selectedProduct: EventEmitter<any> = new EventEmitter();
	public table: any = null;
	public tableId: string = 'dtBuscarProductoConsumo';
	...
	loadTable(search: boolean = false, searchQuery: string = '') {
		...
		let apiURL = (searchQuery.length == 0)
						? this._productoService.url+'/search/consumo'
						: this._productoService.url+'/search/consumo/'+searchQuery;
